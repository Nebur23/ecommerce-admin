...
const ApiAlert: React.FunctionComponent<IApiAlertProps> = ({
  ...
  return (
    <Alert>
        ...
        <AlertTitle className="flex items-center gap-x-2">
             {title}
             <Badge variant={variantMap[variant as keyof typeof variantMap]}>
                {textMap[variant as keyof typeof textMap]}
            </Badge>
        </AlertTitle>
